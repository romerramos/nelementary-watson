...
function M.get_workspace_root(buf)
  ...
  local git_root = vim.fn.systemlist("git -C " .. vim.fn.shellescape(vim.fn.fnamemodify(buf_path, ":h")) .. " rev-parse --show-toplevel 2>/dev/null")[1]
...
function M.debug_print(msg)
  ...
  if config.options.debug then
    print("Nelson Elementary Watson: " .. msg)
  end
end
